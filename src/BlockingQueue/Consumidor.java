...
public class Consumidor extends Thread {
    ...
    /**
     * <p> Método construtor que recebe a fila, nome e tempo de espera. </p>
     * 
    ...
    /**
     * <p> Método em que o fazendeiro faz a retirada do produto da fila, após um determinado
     * tempo de espera, ele poderá realizar a retirada novamente.
     * Também, o loop será encerrado quando a classe Produtor chegar ao fim do seu loop. </p>
     */
    public void run() {
        while(true) {
            try {
