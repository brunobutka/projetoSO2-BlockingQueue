...
public class Produtor extends Thread {
    ...
    /**
     * <p> Método construtor que recebe a fila, nome do protudo, o nome do produtor, 
     * o tempo de espera e a quantidade de execuções. </p>
     * 
    ...
    /**
     * <p> Método em que o produtor faz a inserção do produto da fila, após um determinado
        ...
        while(cont < qtdExecucoes) {
            try {
                if(fazenda.size() == 2) {
                    ...
                    System.out.println("A " + nome + " produziu " + this.produto + "(" + (fazenda.size() + 1) + ") na fazenda");
